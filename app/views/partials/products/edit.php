...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Products</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("products/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-brand_id"  value="<?php  echo $data['brand_id']; ?>" type="number" placeholder="Enter Brand Id" step="1"  required="" name="brand_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-tax"  value="<?php  echo $data['tax']; ?>" type="text" placeholder="Enter Tax"  required="" name="tax"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-price"  value="<?php  echo $data['price']; ?>" type="number" placeholder="Enter Price" step="0.1"  required="" name="price"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-stock"  value="<?php  echo $data['stock']; ?>" type="number" placeholder="Enter Stock" step="1"  required="" name="stock"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-discount"  value="<?php  echo $data['discount']; ?>" type="number" placeholder="Enter Discount" step="0.1"  required="" name="discount"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-minimum_amount"  value="<?php  echo $data['minimum_amount']; ?>" type="text" placeholder="Enter Minimum Amount"  required="" name="minimum_amount"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-free_delivery"  value="<?php  echo $data['free_delivery']; ?>" type="text" placeholder="Enter Free Delivery"  required="" name="free_delivery"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-total_view"  value="<?php  echo $data['total_view']; ?>" type="text" placeholder="Enter Total View"  required="" name="total_view"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <textarea placeholder="Enter Features" id="ctrl-features"  required="" rows="5" name="features" class=" form-control"><?php  echo $data['features']; ?></textarea>
                                                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <div class="dropzone required" input="#ctrl-thumb_image" fieldname="thumb_image"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                                                    <input name="thumb_image" id="ctrl-thumb_image" required="" class="dropzone-input form-control" value="<?php  echo $data['thumb_image']; ?>" type="text"  />
                                                                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                        <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <?php Html :: uploaded_files_list($data['thumb_image'], '#ctrl-thumb_image'); ?>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <textarea placeholder="Enter Slug" id="ctrl-slug"  required="" rows="5" name="slug" class=" form-control"><?php  echo $data['slug']; ?></textarea>
                                                                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
