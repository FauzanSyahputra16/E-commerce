                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-role_id"  value="<?php  echo $this->set_field_value('role_id',"4"); ?>" type="number" placeholder="Enter Role Id" step="1"  required="" name="role_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-email_verified_at"  value="<?php  echo $this->set_field_value('email_verified_at',""); ?>" type="email" placeholder="Enter Email Verified At"  required="" name="email_verified_at"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <input id="ctrl-remember_token"  value="<?php  echo $this->set_field_value('remember_token',""); ?>" type="text" placeholder="Enter Remember Token"  required="" name="remember_token"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
