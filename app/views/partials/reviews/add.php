            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="reviews-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("reviews/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-rattings"  value="<?php  echo $this->set_field_value('rattings',""); ?>" type="number" placeholder="Enter Rattings" step="1"  required="" name="rattings"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-parent_id"  value="<?php  echo $this->set_field_value('parent_id',""); ?>" type="number" placeholder="Enter Parent Id" step="1"  required="" name="parent_id"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
