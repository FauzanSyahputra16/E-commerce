    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("companies/add") ?>">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("companies/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-user_id">
                                                    ...
                                                    <td class="td-tin">
                                                        <span  data-value="<?php echo $data['tin']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("companies/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="tin" 
                                                            data-title="Enter Tin" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("companies/edit/$rec_id"); ?>">
