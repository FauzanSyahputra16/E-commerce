...
class ReviewsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				reviews.id LIKE ? OR 
				reviews.user_id LIKE ? OR 
				reviews.rattings LIKE ? OR 
				reviews.description LIKE ? OR 
				reviews.parent_id LIKE ? OR 
				reviews.creator LIKE ? OR 
				reviews.slug LIKE ? OR 
				reviews.status LIKE ? OR 
				reviews.created_at LIKE ? OR 
				reviews.updated_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("user_id","rattings","description","parent_id","creator","slug","status","created_at","updated_at");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'user_id' => 'required|numeric',
				'rattings' => 'required|numeric',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","user_id","rattings","description","parent_id","creator","slug","status","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'user_id' => 'required|numeric',
