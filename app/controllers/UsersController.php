...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				users.creator LIKE ? OR 
				users.slug LIKE ? OR 
				users.status LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("role_id","first_name","last_name","username","photo","phone","email","address","email_verified_at","password","creator","slug","status","remember_token","created_at","updated_at");
